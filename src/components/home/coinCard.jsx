...
const coinCard = ({coin}) => {
  console.log(coin);
    ...
    return (
    <Link to={`/coin/${coin.id}`} className="bg-white dark:bg-gray-800 hover:shadow-lg p-6 cursor-pointer hover:scale-105 transform transition">
        ...
        <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                    ...
                    <span className="absolute -top-2 -right-2 bg-blue-500 text-white text-xs size-6 rounded-full flex items-center justify-center font-bold">{coin.market_cap_rank}</span>
                </div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>{new Date(coin.last_updated).toLocaleDateString("tr", {
                day: "2-digit",
                month: "2-digit",
                hour: "2-digit",
                minute: "2-digit",
